...
def main(sysargs=sys.argv[1:]):
    ...
    train_parser.add_argument('-ms','--min_split',help='Range of values for minimum sample split to consider in the random forest during optimisation',default=(5,10),dest='min_split_range',nargs=2,type=int)
    train_parser.add_argument('-ml','--min_leaf',help='Range of values for minimum leaf samples to consider in the random forest during optimisation',default=(3,5),dest='min_leaf_range',nargs=2,type=int)
    train_parser.add_argument('-mi','--min_impurity',help='Range of values for the minimum impurity decrease to consider in the random forest during optimisation - must be in [0,1]',default=(0,0.5),dest='min_imp_range',nargs=2,type=float)
    train_parser.add_argument('-cv','--cv_folds',help='The number of folds to use for k-folds cross validation during optimisation',default=5,dest='folds',type=int)
